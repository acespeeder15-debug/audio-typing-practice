...
export function buildExportPayload(settings, wordList) {
  return {
    settings: { ...DEFAULT_SETTINGS, ...settings },
    wordList: typeof wordList === 'string' ? wordList : '',
  };
}

export function parseImportedSettingsPayload(imported) {
  ...
  const hasNestedSettings = imported.settings && typeof imported.settings === 'object';
  const settingsSource = hasNestedSettings ? imported.settings : imported;
  const wordList = typeof imported.wordList === 'string'
    ? imported.wordList
    : (typeof imported.savedWordList === 'string' ? imported.savedWordList : '');

  return {
    settings: { ...DEFAULT_SETTINGS, ...settingsSource },
    wordList,
  };
}
